...
public class AccountsController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    ...
                    // The reason to have the @Content annotation is that without it,
                    // the error response DTO is not visible in the Swagger UI
                    content = @Content(
    ...
    public ResponseEntity<ResponseDto> deleteAccountDetails(@RequestParam @Valid @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits")
                                                                String mobileNumber) {
